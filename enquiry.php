...
<html lang="en">
  <head>
    ...
    <title>Destination Enquiry</title>
  ...
  <body>
    ...
    <section id="contact">
		...
		<?php
						...
						$subject="Enquiry for ".$_POST['Type']; 
						$user=$_POST['Name'];
						$txt="From: ".$user."\n"."No. of people: ".$_POST['NOP']."\n"."Contact No.: ".$_POST['Mobile']."\n"."Type of trip: ".$_POST['Type']."\n"."Enquiry: ".$_POST['Enquiry'];
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <form name="sentMessage" id="contactForm" action="" method="POST">
                        <div id="form" class="contact-form">
                            <h3><b>Are you having some problem and wish to enquire something??
							<br>
							<br>
							Here you are!</b>
							</h3>
							...
							<br>                            
								...
								<div class="form-group">
                                    <select autocomplete="off" class="form-control" name="Type" style="border-color:#0b102c; border-radius:0px; height: 50px; padding: 15px 10px;" id="Type" required data-validation-required-message="Please enter your type.">
										<option class="form-control" value="" disabled selected style="display:none">DESTINATION</option>
										<option class="form-control" value="Beas Ghat">Beas Ghat</option>
										<option class="form-control" value="Chakrata">Chakrata</option>
										<option class="form-control" value="Har Ki Dun">Har Ki Dun</option>
										<option class="form-control" value="Kareri Lake">Kareri Lake</option>
										<option class="form-control" value="Mundali">Mundali</option>
									</select>
                                    <p class="help-block text-danger"></p>
                                </div>
								<div class="form-group">
                                    <textarea class="form-control" placeholder="Your Enquiry *" name="Enquiry" required data-validation-required-message="Please enter a message."></textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
							<br>
                        <div class="text-center">
                            <div id="success"></div>
                            <button type="submit" name="submit" value="submit" class="btn btn-primary contact-btn">Send My Enquiry</button> <!-- Send button -->
                        </div>
                    </form>
                </div>
            </div> <!-- End Row -->
