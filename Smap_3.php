        ...
        <div class="header-static">
            <div class="featured-content static">
                ...
                <div class="post-details">
                    <img src="img/past/Smap_3/1.jpg" class="img-responsive" alt="...">
                     <div class="text-overlay">
                        ...
                        <p class="excerpt">
						This trip was the first time we took more than 50 unknown people. We hardly had any clue that these 50 strangers will turn out to be such an amazing family.The trip had amazing activities such as rafting, river crossing, cliff jumping and night trek etc.apart from the aforementioned adventure activities people enjoyed various team building activities and music which helped them relax.
						<br><br>
						To add on to the happiness of the family, smapsters gifted T shirts and wristbands to each and every one of them. It was exceptional to how everyone got so close by the end of the trip.This was one of the finest trip organised by Smapsters.
						</p>
                        ...
                        <div id="content">
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_3/2.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_3/3.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_3/4.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_3/5.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_3/6.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_3/7.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
