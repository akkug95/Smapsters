        ...
        <div class="header-static">
            <div class="featured-content static">
                ...
                <div class="post-details">
                    <img src="img/Upcoming/Smap_11/1.jpg" class="img-responsive" alt="...">
                     <div class="text-overlay">
                        <div class="title">
                            <h2>Smapsters 11.0</h2>
                        </div>
                        <div class="metas">
                            <h4><b>Location Yet to be Decided</b></h4>
                        </div>
						<div class="metas">
                                <!--a href="PDF/Har-ki-dun.pdf" target="#blank"><h5>Itenerary: Smapsters 6.0 <i class="fa fa-file-pdf-o fa-1x"></i></h5></a>
                                <h5>Cost: ₹15000</h5-->
                        </div>
                        <p class="excerpt">
                        ...
                        <!--div id="content">
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/Upcoming/Smap_8/2.jpeg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/Upcoming/Smap_8/3.jpeg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/Upcoming/Smap_8/4.jpeg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/Upcoming/Smap_8/5.jpeg" class="img-responsive" alt="...">
                                </div>
                            </div>
