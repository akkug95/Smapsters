        ...
        <div class="container"> <!-- Start Container -->
            <div class="row"> <!-- Start Row -->
                <div class="col-md-10 col-md-offset-1">
					...
					<center><h3>Not a user yet? <a href="signup.php"><b>Sign Up</b></a></h3></center>
					<center>
					<div>
						<?php 
...
echo '<a href="' . htmlspecialchars($loginUrl) . '"><img src="img/facebook.png"></a>';
?>
				<!--	<a href="$loginUrl" title="We are working on it"><img src="img/facebook.png">	</a> -->
						&nbsp;&nbsp;
