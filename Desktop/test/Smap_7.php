        ...
        <div class="header-static">
            <div class="featured-content static">
                ...
                <div class="post-details">
                    <img src="img/past/Smap_7/4.jpg" class="img-responsive" alt="...">
                     <div class="text-overlay">
                        <div class="title">
                            <h2>Smapsters 7.0</h2>
                        </div>
                        <div class="metas">
                            <h4><b>Koruwa Edition</b></h4>
                        </div>
                        <p class="excerpt">
						The travel group consisted of 54 diverse people. The group did a trek to Budher Caves where they enjoyed the beautiful meadows, a day well spent.
						<br><br>
						Other activities done were night trek, cliff jumping, river crossing. Some sessions included trek to Tiger falls, cultural folk dance of that place, with our dancing sessions.
						All of them were also competitive enough to compete with one another in the in house activities like foosball, pool, and table tennis.
						</p>
                        ...
                        <div id="content">
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_7/2.jpg" class="img-responsive" alt="...">
                                </div>
								<div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_7/1.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_7/3.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
                        </div>
