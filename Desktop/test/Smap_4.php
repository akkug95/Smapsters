        ...
        <div class="header-static">
            <div class="featured-content static">
                ...
                <div class="post-details">
                    <img src="img/past/Smap_4/7.jpg" class="img-responsive" alt="...">
                     <div class="text-overlay">
                        <div class="title">
                            <h2>Smapsters 4.0</h2>
                        </div>
                        <div class="metas">
                            <h4><b>Kareri Lake</b></h4>
                        </div>
                        <p class="excerpt">
						Kareri Lake is a high altitude, shallow,  freshwater. Its surface is at an altitude of 2934 m above sea level. The lake can be approached only by trekking through trails starting either from Kareri Village(13 km) or from Mcleodganj (27 km) with an overnight stay at Kareri Village.
						<br><br>
						The view of the lake surrounded by Dhauladhar range is a stunning sight and will make the long trek worth. The trip turned 54 travellers into 54 members of the Kareri family who called themselves Karerians.
						</p>
                        ...
                        <div id="content">
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_4/2.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_4/1.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_4/4.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_4/5.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_4/6.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_4/3.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
