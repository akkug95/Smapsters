        ...
        <div class="header-static">
            <div class="featured-content static">
                ...
                <div class="post-details">
                    <img src="img/past/Smap_1/1.jpg" class="img-responsive" alt="...">
                     <div class="text-overlay">
                        <div class="title">
                            <h2>Smapsters 1.0</h2>
                        </div>
                        <div class="metas">
                            <h4><b>Tatta Paani</b></h4>
                        </div>
                        <p class="excerpt">
						Tattapaani refers to a hot water sulphur spring which is situated on the banks of river Sutlej. Sulphur springs of this kind are invigorating and have curative powers. A dip in these steaming springs provide the much needed relief. The spring is located just 51 km from Shimla, the capital city of Himachal Pradesh. 
						<br><br>
						This trip made the group of travel enthusiasts realize the significance of travelling and how it became missing in our daily life and became the reason for all the other SMAPSTERS X.0 s.
						</p>
                        ...
                        <div id="content">
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_1/2.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_1/3.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_1/4.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_1/5.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
