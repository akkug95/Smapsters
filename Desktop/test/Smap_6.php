        ...
        <div class="header-static">
            <div class="featured-content static">
                ...
                <div class="post-details">
                    <img src="img/past/Smap_6/6.jpg" class="img-responsive" alt="...">
                     <div class="text-overlay">
                        <div class="title">
                            <h2>Smapsters 6.0</h2>
                        </div>
                        <div class="metas">
                            <h4><b>Garwhal Edition</b></h4>
                        </div>
                        <p class="excerpt">
						The destination was a campsite in Jayalgarh, where the river was just a few steps far. The group of 24 travellers did rappelling, rafting,night trek,day trek, cliff jumping and body surfing and slithering during the trip. But the best part turned out to be the bonding amongst themselves which they took back.
						<br><br>
						The way the entire group came up together for all the team building activities and dance sessions was unique, so unique that on the last night all of them preferred to sleep together in the open area with their sleeping bags, rather than in their tents.
						</p>
                        ...
                        <div id="content">
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_6/2.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_6/3.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_6/4.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_6/5.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_6/1.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
