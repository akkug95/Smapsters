                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <form name="sentMessage" id="contactForm" action="" method="POST">
                        <div id="form" class="contact-form">
                            <h3><b>Liked our work and want us to plan your expedition?
							<br>
							<br>
							...
							<br>                            
								...
								<div class="form-group">
                                    <select autocomplete="off" class="form-control" name="Type" style="border-color:#0b102c; border-radius:0px; height: 50px; padding: 15px 10px;" id="Type" required data-validation-required-message="Please enter your type.">
										<option class="form-control" value="" disabled selected style="display:none">TYPE OF TRIP</option>
										<option class="form-control" value="leisure">Leisure</option>
										<option class="form-control" value="trekking">Trekking</option>
										<option class="form-control" value ="camping">Camping</option>
									</select>
                                    <p class="help-block text-danger"></p>
                                </div>
								
                                <div class="form-group">
                                    <input type="text" autocomplete="off" class="form-control" placeholder="Estimated Budget *" name="budget" required data-validation-required-message="Please enter your email.">                            
                                    <p class="help-block text-danger"></p>
                                </div>
                        ...
                        <div class="text-center">
                            <div id="success"></div>
                            <button type="submit" name="submit" value="submit" class="btn btn-primary contact-btn">Customise My Trip</button> <!-- Send button -->
                        </div>
                    </form>
