        ...
        <div class="header-static">
            <div class="featured-content static">
                ...
                <div class="post-details">
                    <img src="img/past/Smap_5/3.jpg" class="img-responsive" alt="...">
                     <div class="text-overlay">
                        ...
                        <p class="excerpt">
						Our first corporate venture was with the teach india group which is an initiative by the Times of India group. This trip was an excellent mix of adventure and leisure for the corporates. The motive of this trip was not just to enjoy and have fun but also to enhance the team bonding. This group experienced the blissful sunset, beautiful tiger falls, local celebrations and adventurous mountain activities.
						<br><br>
						It was amazing to see how the organising team and the teach india group gelled in together.By the end of the trip the team was closer than ever and requested more of such trips.Everybody loved the place and how beautifully the trip was executed.
						</p>
                        ...
                        <div id="content">
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_5/2.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_5/1.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
							<div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_5/4.jpg" class="img-responsive" alt="...">
                                </div>

                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="img/past/Smap_5/5.jpg" class="img-responsive" alt="...">
                                </div>
                            </div>
                        </div>
